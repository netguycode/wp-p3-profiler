<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
		...
		var links = [];
		var i = 1;
		$("h2.p3-help-question").each(function() {
...
<div class="p3-question">
	...
	<blockquote>
		...
		or Safari or Chrome's developer console can show you a connection breakdown of your site's content.
	</blockquote>
</div>
...
<div class="p3-question">
	<h2 class="p3-help-question">Glossary</h2>
	<div>
